...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should update payment_notification" do
    patch :update, id: @payment_notification, payment_notification: { cart_id: @payment_notification.cart_id, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id }
    assert_redirected_to payment_notification_path(assigns(:payment_notification))
  end
